...
export function addMarginsForPIP(horizontal,vertical,type)
 ...
 export function setPIPEnabled(enabled)
 {
 ...
 export function dismissPIP()
 {
  return Rncustomerglu.dismissPIP()
 }
 export function isCampaignValid(campaignId)
 {
  return Rncustomerglu.isCampaignValid(campaignId)
 }
