...
const BannerWidget = exports.BannerWidget = _reactNative.UIManager.getViewManagerConfig(ComponentName) != null ? (0, _reactNative.requireNativeComponent)(ComponentName) : () => {
  throw new Error(LINKING_ERROR);
};
const EmbedBannerName = 'EmbedBannerWidget';
const EmbedBannerWidget = exports.EmbedBannerWidget = _reactNative.UIManager.getViewManagerConfig(EmbedBannerName) != null ? (0, _reactNative.requireNativeComponent)(EmbedBannerName) : () => {
  throw new Error(LINKING_ERROR);
};
...
function loadCampaignById(id, obj = {}) {
...
function SetCGCurrentClassName(clname, epochTimeStamp) {
...
function openNudge(nudgeid, data = {}) {
  if (nudgeid != null) {
