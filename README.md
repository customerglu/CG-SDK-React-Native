...
- [Features](#features)
- [What's New in 4.1.1](#whats-new-in-400)
...
The React Native SDK automatically pulls in the native iOS SDK (`CustomerGlu 4.1.1`) via CocoaPods.

### Android Setup

The native Android SDK (`com.customerglu:CustomerGluLibrary:4.1.1`) is resolved automatically via Maven Central.
