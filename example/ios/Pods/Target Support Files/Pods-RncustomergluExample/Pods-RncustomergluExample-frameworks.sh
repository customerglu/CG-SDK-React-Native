...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/CustomerGlu/CustomerGlu.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-rncustomerglu/react_native_rncustomerglu.framework"
